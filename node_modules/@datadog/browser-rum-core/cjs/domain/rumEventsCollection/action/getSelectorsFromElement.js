...
function getClassSelector(element) {
    if (element.classList.length > 0) {
        var orderedClassList = (0, browser_core_1.arrayFrom)(element.classList).sort();
        return "".concat(element.tagName).concat(orderedClassList.map(function (className) { return ".".concat((0, browser_core_1.cssEscape)(className)); }).join(''));
    }
}
