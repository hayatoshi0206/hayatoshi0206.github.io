...
declare function newClick(lifeCycle: LifeCycle, history: ClickActionIdHistory, getUserActivity: OnClickContext['getUserActivity'], clickActionBase: Pick<ClickAction, 'startClocks' | 'event' | 'name' | 'target' | 'position'>): {
    event: MouseEvent & {
        target: Element;
    };
