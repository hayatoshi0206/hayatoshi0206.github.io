...
function startRecording(lifeCycle, configuration, sessionManager, viewContexts, worker) {
    var _a = (0, segmentCollection_1.startSegmentCollection)(lifeCycle, configuration.applicationId, sessionManager, viewContexts, function (data, metadata, rawSegmentBytesCount) {
        return (0, send_1.send)(configuration.sessionReplayEndpointBuilder, data, metadata, rawSegmentBytesCount);
