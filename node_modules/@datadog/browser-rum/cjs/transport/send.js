...
function send(endpointBuilder, data, metadata, rawSegmentBytesCount) {
    ...
    var request = new browser_core_1.HttpRequest(endpointBuilder, segmentCollection_1.SEGMENT_BYTES_LIMIT);
